...
namespace ProyectoPrestamo.Controllers
{
    public class PrestamoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPrestamo,IdFiador,IdCliente,Monto,Periodo,Interes")] Prestamo prestamo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPrestamo,IdFiador,IdCliente,Monto,Periodo,Interes")] Prestamo prestamo)
        {
